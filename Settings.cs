...
namespace LiveSplit.JKJO2
{
    ...
    partial class Settings : UserControl
    {
        ...
        public DeepPointer p_maxSecrets { get; set; }
        ...
        {
            p_LevelName = new DeepPointer(0x4226F9);
            p_currentSecrets = new DeepPointer("jk2gamex86.dll", 0x0026CDD4, 0x6c0);
            p_maxSecrets = new DeepPointer("jk2gamex86.dll", 0x0026CDD4, 0x6c4);
            p_levelKills = new DeepPointer("jk2gamex86.dll", 0x0026CDD4, 0x6d4);
            p_maxKills = null;
            ...
            p_svFPS = new DeepPointer(0x00E7CF4C, 0x20);
        }
